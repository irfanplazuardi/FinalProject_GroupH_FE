...
const CreateAnnouncementModal = () => {
  ...
  return (
    <>
      <button className="px-2 hover:bg-gray-800 rounded-lg bg-black text-white h-[4.7vh] w-[21vw] text-xl" onClick={toggleModal}>
        New Announcement
      </button>
      {isOpen && (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-gray-900 bg-opacity-50">
          <div className="flex flex-col justify-center gap-4 bg-white p-8 rounded-lg w-[25vw] h-[40vh]">
            <div className="flex flex-col justify-center items-center gap-5">
              ...
              <textarea className="bg-white p-2 border border-black rounded-lg w-[20vw] h-[20vh]" value={announcementDesc} onChange={(e) => setAnnouncementDesc(e.target.value)}></textarea>
