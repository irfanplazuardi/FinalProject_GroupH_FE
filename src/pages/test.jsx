    ...
    <>
      ...
      <Container className="h-screen p-4 sm:ml-64 bg-white">
        ...
        <Container className="flex justify-between ">
          ...
          <Container className="flex gap-5">
            <CourseModal />
            <button className="bg-gray-300 hover:bg-orange-700 text-black font-bold py-2 px-4 rounded-3xl w-40 h-10"> Edit</button>
            <button className="bg-gray-300 hover:bg-orange-700 text-black font-bold py-2 px-4 rounded-3xl w-40 h-10"> Delete</button>
          </Container>
        </Container>
